...
/**
 * description : flink17--- window 滚动窗口
 *
 * @author kunlunrepo
 * date :  2024-05-13 16:24
 */
public class Flink17App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 5秒滚动窗口
        SingleOutputStreamOperator<VideoOrder> sumDS = keyByDS.window(TumblingProcessingTimeWindows.of(Time.seconds(5)))
                .sum("money");
        sumDS.print();
