...
/**
 * description : flink21--- window 全窗口函数
 *
 * @author kunlunrepo
 * date :  2024-05-13 16:24
 */
public class Flink21App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 5秒滚动窗口
        SingleOutputStreamOperator<VideoOrder> applyDS = keyByDS.window(TumblingProcessingTimeWindows.of(Time.seconds(5)))
                .apply(new WindowFunction<VideoOrder, VideoOrder, String, TimeWindow>() {
                    @Override
                    public void apply(String key, TimeWindow window, Iterable<VideoOrder> in, Collector<VideoOrder> out) throws Exception {
